...
Functional CSS for max-height-percentages

## Filesize

| File | Size |
|------|------|
| `dist/max-height-percentages.css` | 15649 bytes |
| `dist/max-height-percentages.min.css` | 10235 bytes (1475 Gzipped) |

## Install

```sh
npm install css-max-height-percentages
```
...
```html
<link rel="stylesheet" href="https://unpkg.com/css-max-height-percentages/dist/max-height-percentages.min.css">
```

### Direct

```html
<link rel="stylesheet" href="path/to/css-max-height-percentages/dist/max-height-percentages.min.css">
```
...
| `.mxhi-1-s` | `max-height: 1%;` |
| `.mxhi-2-s` | `max-height: 2%;` |
| `.mxhi-3-s` | `max-height: 3%;` |
| `.mxhi-4-s` | `max-height: 4%;` |
| `.mxhi-5-s` | `max-height: 5%;` |
| `.mxhi-6-s` | `max-height: 6%;` |
| `.mxhi-7-s` | `max-height: 7%;` |
| `.mxhi-8-s` | `max-height: 8%;` |
| `.mxhi-9-s` | `max-height: 9%;` |
| `.mxhi-10-s` | `max-height: 10%;` |
| `.mxhi-11-s` | `max-height: 11%;` |
| `.mxhi-12-s` | `max-height: 12%;` |
| `.mxhi-13-s` | `max-height: 13%;` |
| `.mxhi-14-s` | `max-height: 14%;` |
| `.mxhi-15-s` | `max-height: 15%;` |
| `.mxhi-16-s` | `max-height: 16%;` |
| `.mxhi-17-s` | `max-height: 17%;` |
| `.mxhi-18-s` | `max-height: 18%;` |
| `.mxhi-19-s` | `max-height: 19%;` |
| `.mxhi-20-s` | `max-height: 20%;` |
| `.mxhi-21-s` | `max-height: 21%;` |
| `.mxhi-22-s` | `max-height: 22%;` |
| `.mxhi-23-s` | `max-height: 23%;` |
| `.mxhi-24-s` | `max-height: 24%;` |
| `.mxhi-25-s` | `max-height: 25%;` |
| `.mxhi-26-s` | `max-height: 26%;` |
| `.mxhi-27-s` | `max-height: 27%;` |
| `.mxhi-28-s` | `max-height: 28%;` |
| `.mxhi-29-s` | `max-height: 29%;` |
| `.mxhi-30-s` | `max-height: 30%;` |
| `.mxhi-31-s` | `max-height: 31%;` |
| `.mxhi-32-s` | `max-height: 32%;` |
| `.mxhi-33-s` | `max-height: 33%;` |
| `.mxhi-34-s` | `max-height: 34%;` |
| `.mxhi-35-s` | `max-height: 35%;` |
| `.mxhi-36-s` | `max-height: 36%;` |
| `.mxhi-37-s` | `max-height: 37%;` |
| `.mxhi-38-s` | `max-height: 38%;` |
| `.mxhi-39-s` | `max-height: 39%;` |
| `.mxhi-40-s` | `max-height: 40%;` |
| `.mxhi-41-s` | `max-height: 41%;` |
| `.mxhi-42-s` | `max-height: 42%;` |
| `.mxhi-43-s` | `max-height: 43%;` |
| `.mxhi-44-s` | `max-height: 44%;` |
| `.mxhi-45-s` | `max-height: 45%;` |
| `.mxhi-46-s` | `max-height: 46%;` |
| `.mxhi-47-s` | `max-height: 47%;` |
| `.mxhi-48-s` | `max-height: 48%;` |
| `.mxhi-49-s` | `max-height: 49%;` |
| `.mxhi-50-s` | `max-height: 50%;` |
| `.mxhi-51-s` | `max-height: 51%;` |
| `.mxhi-52-s` | `max-height: 52%;` |
| `.mxhi-53-s` | `max-height: 53%;` |
| `.mxhi-54-s` | `max-height: 54%;` |
| `.mxhi-55-s` | `max-height: 55%;` |
| `.mxhi-56-s` | `max-height: 56%;` |
| `.mxhi-57-s` | `max-height: 57%;` |
| `.mxhi-58-s` | `max-height: 58%;` |
| `.mxhi-59-s` | `max-height: 59%;` |
| `.mxhi-60-s` | `max-height: 60%;` |
| `.mxhi-61-s` | `max-height: 61%;` |
| `.mxhi-62-s` | `max-height: 62%;` |
| `.mxhi-63-s` | `max-height: 63%;` |
| `.mxhi-64-s` | `max-height: 64%;` |
| `.mxhi-65-s` | `max-height: 65%;` |
| `.mxhi-66-s` | `max-height: 66%;` |
| `.mxhi-67-s` | `max-height: 67%;` |
| `.mxhi-68-s` | `max-height: 68%;` |
| `.mxhi-69-s` | `max-height: 69%;` |
| `.mxhi-70-s` | `max-height: 70%;` |
| `.mxhi-71-s` | `max-height: 71%;` |
| `.mxhi-72-s` | `max-height: 72%;` |
| `.mxhi-73-s` | `max-height: 73%;` |
| `.mxhi-74-s` | `max-height: 74%;` |
| `.mxhi-75-s` | `max-height: 75%;` |
| `.mxhi-76-s` | `max-height: 76%;` |
| `.mxhi-77-s` | `max-height: 77%;` |
| `.mxhi-78-s` | `max-height: 78%;` |
| `.mxhi-79-s` | `max-height: 79%;` |
| `.mxhi-80-s` | `max-height: 80%;` |
| `.mxhi-81-s` | `max-height: 81%;` |
| `.mxhi-82-s` | `max-height: 82%;` |
| `.mxhi-83-s` | `max-height: 83%;` |
| `.mxhi-84-s` | `max-height: 84%;` |
| `.mxhi-85-s` | `max-height: 85%;` |
| `.mxhi-86-s` | `max-height: 86%;` |
| `.mxhi-87-s` | `max-height: 87%;` |
| `.mxhi-88-s` | `max-height: 88%;` |
| `.mxhi-89-s` | `max-height: 89%;` |
| `.mxhi-90-s` | `max-height: 90%;` |
| `.mxhi-91-s` | `max-height: 91%;` |
| `.mxhi-92-s` | `max-height: 92%;` |
| `.mxhi-93-s` | `max-height: 93%;` |
| `.mxhi-94-s` | `max-height: 94%;` |
| `.mxhi-95-s` | `max-height: 95%;` |
| `.mxhi-96-s` | `max-height: 96%;` |
| `.mxhi-97-s` | `max-height: 97%;` |
| `.mxhi-98-s` | `max-height: 98%;` |
| `.mxhi-99-s` | `max-height: 99%;` |
| `.mxhi-100-s` | `max-height: 100%;` |
...
Example: `.mxhi-1-m` applies the property at the medium breakpoint and above.
...
Processes `src/max-height-percentages.css` with [Lightning CSS](https://lightningcss.dev) and outputs to `dist/`.

- `dist/max-height-percentages.css` — formatted
- `dist/max-height-percentages.min.css` — minified
